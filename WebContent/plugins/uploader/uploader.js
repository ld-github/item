...
var Uploader = function() {
    ...
    this.init = function(fileNumLimit) {
        ...
        if (!WebUploader.Uploader.support('flash') && WebUploader.browser.ie) {
                ...
                (function(container) {
                    window['expressinstallcallback'] = function(state) {
                        ...
                        case 'Download.Cancelled':
                            new Message().show('您取消了更新');
                            break;

                        case 'Download.Failed':
                            new Message().show('安装失败');
                            break;

                        default:
                            new Message().show('安装已成功，请刷新');
                            break;
                        }
            ...
            new Message().show('Web Uploader 不支持您的浏览器');
            return;
        }
        ...
        function setState(val) {
            ...
            case 'finish':
                stats = uploader.getStats();
                if (stats.successNum) {
                    new Message().show('成功上传' + stats.successNum + "个文件");
                } else {
                    state = 'done';
                    location.reload();
                }
        ...
        uploader.onError = function(code) {
            ...
            new Message().show('错误: ' + (msg ? msg : code));
        };
